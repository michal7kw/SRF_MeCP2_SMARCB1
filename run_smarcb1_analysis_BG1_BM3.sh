...
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --error="/beegfs/scratch/ric.broccoli/kubacki.michal/Azenta/logs/smarcb1_BG1_BM3.err"
#SBATCH --output="/beegfs/scratch/ric.broccoli/kubacki.michal/Azenta/logs/smarcb1_BG1_BM3.out"
...
#     --output results/gene_promoters_cpg.bed
...
python scripts/count_reads_in_peaks.py \
    --peaks results/gene_promoters_cpg.bed \
