...
bowtie2 -p 32 -x /beegfs/scratch/ric.broccoli/kubacki.michal/Azenta/mm10/mm10 \
    -1 90-1102945428/00_fastq/BM3_R1_001.fastq.gz \
    -2 90-1102945428/00_fastq/BM3_R2_001.fastq.gz | \
samtools sort -@ 32 -o results/bowtie2_alt/BM3.sorted.bam - 

# 2. Index the BAM file
samtools index results/bowtie2_alt/BM3.sorted.bam

# 3. Call peaks using MACS2
macs2 callpeak \
    -t results/bowtie2_alt/BM3.sorted.bam \
    -f BAMPE \
    -g mm \
    -n BM3 \
