#!/bin/bash
#SBATCH --job-name=run_metaprofiles_per_gene_list
#SBATCH --account=kubacki.michal
#SBATCH --mem=64GB
#SBATCH --time=06:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --error="logs/run_metaprofiles_per_gene_list.err"
#SBATCH --output="logs/run_metaprofiles_per_gene_list.out"
