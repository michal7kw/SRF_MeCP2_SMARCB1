#!/bin/bash
#SBATCH --job-name=SMARCB1_Analysis_BG1_BM3
#SBATCH --account=kubacki.michal
#SBATCH --mem=64GB
#SBATCH --time=7-00:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --error="logs/smarcb1_BG1_BM3.err"
#SBATCH --output="logs/smarcb1_BG1_BM3.out"
...
BASE_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_MeCP2_SMARCB1"

# Add variables for file paths
GENE_LIST_DIR="${BASE_DIR}/scripts/genes_lists/iterative_alternative_results_alternative"
GENE_LIST="${GENE_LIST_DIR}/genes_${metric}_${cell_type}.csv"

RESULTS_DIR="${BASE_DIR}/analysis/results_iara/neu_ww"
...
# Create promoter regions and filter for CpG islands
