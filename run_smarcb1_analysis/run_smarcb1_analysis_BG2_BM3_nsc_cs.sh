...
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --error="logs/smarcb1_BG2_BM3.err"
#SBATCH --output="logs/smarcb1_BG2_BM3.out"
...
RESULTS_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/Azenta/analysis/results_iara/nsc_cs"
